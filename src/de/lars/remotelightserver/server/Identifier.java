...
public class Identifier {
	...
	public final static String COLOR_COLOR = "COLOR_COLOR";
	...
	public final static String SC_COLOR_LEFT = "SC_COLOR_LEFT";
	public final static String SC_COLOR_RIGHT = "SC_COLOR_RIGHT";
	
	//WS281x
	public final static String WS_COLOR_ALL = "WS_COLOR_ALL";
	public final static String WS_COLOR_PIXEL = "WS_COLOR_PIXEL";
	...
	public final static String WS_ANI_SPEED = "WS_ANI_STEEP";
